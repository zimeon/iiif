...
class TestAll(unittest.TestCase):
    ...
    def test2_errors(self):
        ...
        self.assertEqual(
            self.get(id + '/100,0,100,100/pct:100/0/color'), 'code400')
        self.assertEqual(
            self.get(id + '/0,100,100,100/pct:100/0/color'), 'code400')
        # Bad size
        ...
        self.assertTrue(self.get(id + '//pct:100/0/color',
                                 map_404_to_400=True), 'code400')
        self.assertTrue(self.get(id + '/full//0/color',
                                 map_404_to_400=True), 'code400')
        self.assertTrue(self.get(id + '/full/full//color',
                                 map_404_to_400=True), 'code400')
        self.assertTrue(self.get(id + '/full/full/0/',
                                 map_404_to_400=True), 'code400')
