...
class TestAll(unittest.TestCase):
    ...
    def test12_decode_except(self):
        self.assertRaises(IIIFError, IIIFRequest(api_version='1.1').split_url, ("bogus"))
        self.assertRaises(IIIFError, IIIFRequest(api_version='1.1').split_url, ("id1/all/270/!pct%3A75.23.jpg"))
