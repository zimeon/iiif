...
class TestAll(unittest.TestCase):
    ...
    def test06_static_partial_tile_sizes(self):
        ...
        self.assertIn('[0, 64, 64, 36][64, 36]', sizes)
        self.assertIn('[64, 0, 36, 64][36, 64]', sizes)
        self.assertIn('[64, 64, 36, 36][36, 36]', sizes)
        ...
        # print(sizes)
        self.assertIn('[0, 0, 1024, 1024][512,]', sizes)
        self.assertIn('[0, 0, 2048, 2048][512,]', sizes)
        self.assertIn('[0, 0, 3467, 4096][434,]', sizes)
        self.assertIn('[0, 0, 512, 512][512,]', sizes)
        self.assertIn('[0, 1024, 1024, 1024][512,]', sizes)
        self.assertIn('[0, 1024, 512, 512][512,]', sizes)
        self.assertIn('[0, 1536, 512, 512][512,]', sizes)
        self.assertIn('[0, 2048, 1024, 1024][512,]', sizes)
        self.assertIn('[0, 2048, 2048, 2048][512,]', sizes)
        self.assertIn('[0, 2048, 512, 512][512,]', sizes)
        self.assertIn('[0, 2560, 512, 512][512,]', sizes)
        self.assertIn('[0, 3072, 1024, 1024][512,]', sizes)
        self.assertIn('[0, 3072, 512, 512][512,]', sizes)
        self.assertIn('[0, 3584, 512, 512][512,]', sizes)
        self.assertIn('[0, 4096, 1024, 1021][512,]', sizes)
        self.assertIn('[0, 4096, 2048, 1021][512,]', sizes)
        self.assertIn('[0, 4096, 3467, 1021][434,]', sizes)
        self.assertIn('[0, 4096, 512, 512][512,]', sizes)
        self.assertIn('[0, 4608, 512, 509][512,]', sizes)
        self.assertIn('[0, 512, 512, 512][512,]', sizes)
        self.assertIn('[1024, 0, 1024, 1024][512,]', sizes)
        self.assertIn('[1024, 0, 512, 512][512,]', sizes)
        self.assertIn('[1024, 1024, 1024, 1024][512,]', sizes)
        self.assertIn('[1024, 1024, 512, 512][512,]', sizes)
        self.assertIn('[1024, 1536, 512, 512][512,]', sizes)
        self.assertIn('[1024, 2048, 1024, 1024][512,]', sizes)
        self.assertIn('[1024, 2048, 512, 512][512,]', sizes)
        self.assertIn('[1024, 2560, 512, 512][512,]', sizes)
        self.assertIn('[1024, 3072, 1024, 1024][512,]', sizes)
        self.assertIn('[1024, 3072, 512, 512][512,]', sizes)
        self.assertIn('[1024, 3584, 512, 512][512,]', sizes)
        self.assertIn('[1024, 4096, 1024, 1021][512,]', sizes)
        self.assertIn('[1024, 4096, 512, 512][512,]', sizes)
        self.assertIn('[1024, 4608, 512, 509][512,]', sizes)
        self.assertIn('[1024, 512, 512, 512][512,]', sizes)
        self.assertIn('[1536, 0, 512, 512][512,]', sizes)
        self.assertIn('[1536, 1024, 512, 512][512,]', sizes)
        self.assertIn('[1536, 1536, 512, 512][512,]', sizes)
        self.assertIn('[1536, 2048, 512, 512][512,]', sizes)
        self.assertIn('[1536, 2560, 512, 512][512,]', sizes)
        self.assertIn('[1536, 3072, 512, 512][512,]', sizes)
        self.assertIn('[1536, 3584, 512, 512][512,]', sizes)
        self.assertIn('[1536, 4096, 512, 512][512,]', sizes)
        self.assertIn('[1536, 4608, 512, 509][512,]', sizes)
        self.assertIn('[1536, 512, 512, 512][512,]', sizes)
        self.assertIn('[2048, 0, 1024, 1024][512,]', sizes)
        self.assertIn('[2048, 0, 1419, 2048][355,]', sizes)
        self.assertIn('[2048, 0, 512, 512][512,]', sizes)
        self.assertIn('[2048, 1024, 1024, 1024][512,]', sizes)
        self.assertIn('[2048, 1024, 512, 512][512,]', sizes)
        self.assertIn('[2048, 1536, 512, 512][512,]', sizes)
        self.assertIn('[2048, 2048, 1024, 1024][512,]', sizes)
        self.assertIn('[2048, 2048, 1419, 2048][355,]', sizes)
        self.assertIn('[2048, 2048, 512, 512][512,]', sizes)
        self.assertIn('[2048, 2560, 512, 512][512,]', sizes)
        self.assertIn('[2048, 3072, 1024, 1024][512,]', sizes)
        self.assertIn('[2048, 3072, 512, 512][512,]', sizes)
        self.assertIn('[2048, 3584, 512, 512][512,]', sizes)
        self.assertIn('[2048, 4096, 1024, 1021][512,]', sizes)
        self.assertIn('[2048, 4096, 1419, 1021][355,]', sizes)
        self.assertIn('[2048, 4096, 512, 512][512,]', sizes)
        self.assertIn('[2048, 4608, 512, 509][512,]', sizes)
        self.assertIn('[2048, 512, 512, 512][512,]', sizes)
        self.assertIn('[2560, 0, 512, 512][512,]', sizes)
        self.assertIn('[2560, 1024, 512, 512][512,]', sizes)
        self.assertIn('[2560, 1536, 512, 512][512,]', sizes)
        self.assertIn('[2560, 2048, 512, 512][512,]', sizes)
        self.assertIn('[2560, 2560, 512, 512][512,]', sizes)
        self.assertIn('[2560, 3072, 512, 512][512,]', sizes)
        self.assertIn('[2560, 3584, 512, 512][512,]', sizes)
        self.assertIn('[2560, 4096, 512, 512][512,]', sizes)
        self.assertIn('[2560, 4608, 512, 509][512,]', sizes)
        self.assertIn('[2560, 512, 512, 512][512,]', sizes)
        self.assertIn('[3072, 0, 395, 1024][198,]', sizes)
        self.assertIn('[3072, 0, 395, 512][395,]', sizes)
        self.assertIn('[3072, 1024, 395, 1024][198,]', sizes)
        self.assertIn('[3072, 1024, 395, 512][395,]', sizes)
        self.assertIn('[3072, 1536, 395, 512][395,]', sizes)
        self.assertIn('[3072, 2048, 395, 1024][198,]', sizes)
        self.assertIn('[3072, 2048, 395, 512][395,]', sizes)
        self.assertIn('[3072, 2560, 395, 512][395,]', sizes)
        self.assertIn('[3072, 3072, 395, 1024][198,]', sizes)
        self.assertIn('[3072, 3072, 395, 512][395,]', sizes)
        self.assertIn('[3072, 3584, 395, 512][395,]', sizes)
        self.assertIn('[3072, 4096, 395, 1021][198,]', sizes)
        self.assertIn('[3072, 4096, 395, 512][395,]', sizes)
        self.assertIn('[3072, 4608, 395, 509][395,]', sizes)
        self.assertIn('[3072, 512, 395, 512][395,]', sizes)
        self.assertIn('[512, 0, 512, 512][512,]', sizes)
        self.assertIn('[512, 1024, 512, 512][512,]', sizes)
        self.assertIn('[512, 1536, 512, 512][512,]', sizes)
        self.assertIn('[512, 2048, 512, 512][512,]', sizes)
        self.assertIn('[512, 2560, 512, 512][512,]', sizes)
        self.assertIn('[512, 3072, 512, 512][512,]', sizes)
        self.assertIn('[512, 3584, 512, 512][512,]', sizes)
        self.assertIn('[512, 4096, 512, 512][512,]', sizes)
        self.assertIn('[512, 4608, 512, 509][512,]', sizes)
        self.assertIn('[512, 512, 512, 512][512,]', sizes)
    ...
    def test07_static_full_sizes(self):
        ...
        for (size) in static_full_sizes(100, 100, 64):
            ...
            self.assertNotEqual(size[1], 0)
            sizes.add(str(size))
        self.assertNotIn('[100, 100]', sizes)
        self.assertIn('[50, 50]', sizes)
        self.assertIn('[25, 25]', sizes)
        self.assertIn('[13, 13]', sizes)
        self.assertIn('[6, 6]', sizes)
        self.assertIn('[3, 3]', sizes)
        self.assertIn('[2, 2]', sizes)
        self.assertIn('[1, 1]', sizes)
