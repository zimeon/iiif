"""Test encoding and decoding of IIIF Image API v1.1 request URLs.

Follows http://www-sul.stanford.edu/iiif/image-api/ v1.0
...
tests_request_spec_1_1.py for the set given in the spec.
