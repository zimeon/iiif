"""Test code for iiif/info.py for Image API v2.1"""
import unittest
...
class TestAll(unittest.TestCase):
    ...
    def test02_scale_factor(self):
        ir = IIIFInfo(width=199,height=299,tile_width=100,tile_height=100,scale_factors=[1,2], api_version='2.1')
    ...
    def test12_read_unknown_context(self):
        i = IIIFInfo(api_version='2.1')
        fh = open('test_info/2.1/info_bad_context.json')
